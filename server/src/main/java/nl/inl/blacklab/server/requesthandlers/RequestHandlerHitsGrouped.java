...
public class RequestHandlerHitsGrouped extends RequestHandler {
    ...
    private void writeHits(DataStream ds, Hits hits, Map<Integer, String> pids) {
    ...
    private void writeDocInfos(DataStream ds, HitGroups hitGroups, Map<Integer, String> pids, int first, int requestedWindowSize) {
